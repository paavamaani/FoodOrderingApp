...
const Demo = () => {
  ...
  const prime = useMemo(() => findPrime(inputValue), [inputValue]);
    ...
    <div className='flex flex-col w-96 h-96'>
      ...
      >
        <h1 className={'font-bold mb-4 ' + (theme && 'text-white')}>
          Intensive computation with useMemo
        </h1>
      ...
      <div className='m-4'>
        <p>
          Enter any six digit in input and try toggling theme to see useMemo in
          action
        </p>
      </div>
    </div>
